...
Next, use your deployed trigger contract to trigger the oracle to be run. In the following command, you'll specify the `TRIGGER_INPUT` as `1`, which corresponds to the ID of Bitcoin.
