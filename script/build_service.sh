...
BASE_CMD="docker run --rm --network host -w /data -v $(pwd):/data ghcr.io/lay3rlabs/wavs:april-21-unified-config wavs-cli service --json true --home /data --file /data/${FILE_LOCATION}"
