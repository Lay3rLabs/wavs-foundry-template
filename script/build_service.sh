...
BASE_CMD="docker run --rm --network host -w /data -v $(pwd):/data ghcr.io/lay3rlabs/wavs:may-6-fix-agg-sort wavs-cli service --json true --home /data --file /data/${FILE_LOCATION}"
