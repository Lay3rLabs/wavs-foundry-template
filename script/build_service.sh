...
BASE_CMD="docker run --rm --network host -w /data -v $(pwd):/data ghcr.io/reecepbcups/wavs:april-23-0.4.0-alpha.5 wavs-cli service --json true --home /data --file /data/${FILE_LOCATION}"
