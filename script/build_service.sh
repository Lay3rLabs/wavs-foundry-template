...
BASE_CMD="docker run --rm --network host -w /data -v $(pwd):/data ghcr.io/lay3rlabs/wavs:local-may-20-morelogs wavs-cli service --json true --home /data --file /data/${FILE_LOCATION}"
