...
BASE_CMD="docker run --rm --network host -w /data -v $(pwd):/data ghcr.io/lay3rlabs/wavs:local-may15-wit-fix wavs-cli service --json true --home /data --file /data/${FILE_LOCATION}"
