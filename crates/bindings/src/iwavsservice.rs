...
pub mod IWavsService {
    ...
    ///Container for all the [`IWavsService`](self) function calls.
    pub enum IWavsServiceCalls {
        handleSignedData(handleSignedDataCall),
    }
    #[automatically_derived]
    impl IWavsServiceCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IWavsServiceCalls {
        const NAME: &'static str = "IWavsServiceCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IWavsServiceCalls>] = &[{
                fn handleSignedData(
                    data: &[u8],
                    validate: bool,
                ) -> alloy_sol_types::Result<IWavsServiceCalls> {
                    ...
                    .map(IWavsServiceCalls::handleSignedData)
                }
                handleSignedData
            }];
    ...
    /**Creates a new wrapper around an on-chain [`IWavsService`](self) contract instance.

    See the [wrapper's documentation](`IWavsServiceInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IWavsServiceInstance<T, P, N> {
        IWavsServiceInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IWavsServiceInstance<T, P, N>>>
    {
        IWavsServiceInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IWavsServiceInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IWavsService`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IWavsService`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IWavsServiceInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IWavsServiceInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IWavsServiceInstance").field(&self.address).finish()
        }
    }
        ...
        > IWavsServiceInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IWavsServiceInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IWavsServiceInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IWavsServiceInstance<T, P, N> {
            IWavsServiceInstance {
